...
class TestPythonTypeToCtyTypePropertyBased:
    ...
    @given(value=st.text())
    def test_str_type_always_produces_cty_string(self, value: str):
    ...
    def test_int_type_always_produces_cty_number(self, value: int):
    ...
    def test_float_type_always_produces_cty_number(self, value: float):
        """Property: float type should always produce CtyNumber."""
        cty_type = _python_type_to_cty_type(float)
        assert isinstance(cty_type, CtyNumber)

    @given(value=st.booleans())
    def test_bool_type_always_produces_cty_bool(self, value: bool):
...
class TestListTypeConversionPropertyBased:
    ...
    def test_list_str_produces_list_of_strings(self):
    ...
    def test_list_int_produces_list_of_numbers(self):
    ...
    def test_list_bool_produces_list_of_bools(self):
    ...
    def test_nested_list_produces_nested_cty_list(self):
...
class TestDictTypeConversionPropertyBased:
    ...
    def test_dict_str_str_produces_map_of_strings(self):
...
class TestUnionTypeConversionPropertyBased:
    ...
    def test_optional_str_is_nullable(self):
    ...
    def test_union_of_numbers_produces_number(self):
        """Property: int | float should produce CtyNumber."""
        cty_type = _python_type_to_cty_type(int | float)
        assert isinstance(cty_type, CtyNumber)

    def test_union_of_different_types_produces_dynamic(self):
...
class TestFunctionConversionPropertyBased:
    ...
    def test_function_with_n_params_produces_n_parameters(self, num_params: int):
