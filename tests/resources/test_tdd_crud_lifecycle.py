...
class TestCrudLifecycleDispatcher:
    ...
    async def test_plan_dispatches_to_update(self, mocker: MockerFixture):
    ...
    async def test_plan_dispatches_to_delete_plan(self, mocker: MockerFixture):
    ...
    async def test_apply_dispatches_to_create_apply(self, mocker: MockerFixture):
    ...
    async def test_apply_dispatches_to_update_apply(self, mocker: MockerFixture):
    ...
    async def test_apply_dispatches_to_delete_apply(self, mocker: MockerFixture):
