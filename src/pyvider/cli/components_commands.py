...
from provide.foundation.logging import FoundationLogger
from provide.foundation.utils import timed_block

from pyvider.cli.context import PyviderContext
from pyvider.cli.main import cli, pass_ctx
...
def show_diagnostics(ctx: PyviderContext) -> None:
    ...
    try:
        ...
        with timed_block(logger_instance=FoundationLogger(), event_name="hub_diagnostics") as timer:
        ...
        if table_data:
            ...
            table = format_table(rows=table_data, headers=["Component Type", "Count"])
...
def show_diagnostics(ctx: PyviderContext) -> None:
    ...
    try:
        ...
        with timed_block(logger_instance=logger, event_name="hub_diagnostics") as timer:
