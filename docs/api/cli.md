...
**Description:**
This is the default command when running the provider binary. Terraform automatically invokes this when using the provider. In development mode without the magic cookie, it displays interactive help.
...
- Environment variables (PYVIDER_*)
...
**Description:**
Analyzes the execution environment and reports:
