...
class TestStopProviderHandlerStructure:
    ...
    @pytest.mark.asyncio
    async def test_handler_returns_response(self):
    ...
    @pytest.mark.asyncio
    async def test_handler_calls_implementation(self):
        """Test that handler delegates to implementation."""
        request = pb.StopProvider.Request()

        with patch(
            "pyvider.protocols.tfprotov6.handlers.stop_provider._stop_provider_impl"
        ) as mock_impl:
...
class TestStopProviderImpl:
    ...
    @pytest.mark.asyncio
    async def test_impl_stops_server_instance(self):
    ...
    @pytest.mark.asyncio
    async def test_impl_handles_no_server_instance(self):
    ...
    @pytest.mark.asyncio
    async def test_impl_raises_on_server_stop_error(self):
...
class TestStopProviderMetrics:
    ...
    @pytest.mark.asyncio
    async def test_handler_records_request_metric(self):
    ...
    @pytest.mark.asyncio
    async def test_handler_records_duration_metric(self):
    ...
    @pytest.mark.asyncio
    async def test_handler_records_error_metric_on_failure(self):
...
class TestStopProviderLogging:
    ...
    @pytest.mark.asyncio
    async def test_impl_logs_shutdown_initiation(self):
    ...
    async def test_impl_logs_server_stop_completion(self):
        ...
        with patch("pyvider.protocols.tfprotov6.handlers.stop_provider.logger") as mock_logger:
            with patch("pyvider.protocols.tfprotov6.handlers.stop_provider.RPCPluginServer") as mock_server_class:
                ...
                assert any(
                    "stop() completed" in str(call) for call in mock_logger.info.call_args_list
                )
    ...
    @pytest.mark.asyncio
    async def test_impl_logs_error_on_exception(self):
...
class TestStopProviderEdgeCases:
    ...
    @pytest.mark.asyncio
    async def test_handler_with_context_object(self):
    ...
    @pytest.mark.asyncio
    async def test_handler_resilience_decorator(self):
    ...
    @pytest.mark.asyncio
    async def test_metrics_recorded_even_on_error(self):
