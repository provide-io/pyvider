...
def x_is_valid_refinement__mutmut_29(plan: CtyValue, result: CtyValue) -> tuple[bool, str]:
    """
    Checks if the `result` state is a valid refinement of the `plan` state.
    A value can be refined from unknown to null/concrete, or from null to concrete.
    It cannot be refined from a concrete value to a different value, null, or unknown.
...
def x_is_valid_refinement__mutmut_30(plan: CtyValue, result: CtyValue) -> tuple[bool, str]:
    """
    Checks if the `result` state is a valid refinement of the `plan` state.
    A value can be refined from unknown to null/concrete, or from null to concrete.
    It cannot be refined from a concrete value to a different value, null, or unknown.
...
'x_is_valid_refinement__mutmut_1': x_is_valid_refinement__mutmut_1, 
    ...
    'x_is_valid_refinement__mutmut_29': x_is_valid_refinement__mutmut_29, 
    'x_is_valid_refinement__mutmut_30': x_is_valid_refinement__mutmut_30
}
